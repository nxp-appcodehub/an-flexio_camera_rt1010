...
void BOARD_SPILCD_RstPinInit(void)
{
    ...
    GPIO_PinInit(BOARD_SPILCD_RST_GPIO_BASE, BOARD_SPILCD_RST_PIN_INDEX, &gpioPinConfig);
}
...
void BOARD_SPILCD_DcPinInit(void)
{
    ...
    GPIO_PinInit(BOARD_SPILCD_DC_GPIO_BASE, BOARD_SPILCD_DC_PIN_INDEX, &gpioPinConfig);
}
...
void BOARD_SPILCD_CsPinInit(void)
{
    ...
    GPIO_PinInit(BOARD_SPILCD_CS_GPIO_BASE, BOARD_SPILCD_CS_PIN_INDEX, &gpioPinConfig);
}
...
void BOARD_SPILCD_LedPinInit(void)
{
    ...
    GPIO_PinInit(BOARD_SPILCD_LED_GPIO_BASE, BOARD_SPILCD_LED_PIN_INDEX, &gpioPinConfig);
}
...
void BOARD_SPILCD_pullRstPin(bool value)
{
    if(value)
    {
        BOARD_SPILCD_RST_GPIO_BASE->DR |=  1<<BOARD_SPILCD_RST_PIN_INDEX;
    }
    else
    {
        BOARD_SPILCD_RST_GPIO_BASE->DR &= ~(1<<BOARD_SPILCD_RST_PIN_INDEX);
...
void BOARD_SPILCD_pullDcPin(bool value)
{
    if(value)
    {
        BOARD_SPILCD_DC_GPIO_BASE->DR |=  1<<BOARD_SPILCD_DC_PIN_INDEX;
    }
    else
    {
        BOARD_SPILCD_DC_GPIO_BASE->DR &= ~(1<<BOARD_SPILCD_DC_PIN_INDEX);
...
void BOARD_SPILCD_pullCsPin(bool value)
{
    if(value)
    {
        BOARD_SPILCD_CS_GPIO_BASE->DR |= 1<<BOARD_SPILCD_CS_PIN_INDEX;
    }
    else
    {
        BOARD_SPILCD_CS_GPIO_BASE->DR &= ~(1<<BOARD_SPILCD_CS_PIN_INDEX);
...
void BOARD_SPILCD_pullLedPin(bool value)
{
    if(value)
    {
        BOARD_SPILCD_LED_GPIO_BASE->DR |= 1<<BOARD_SPILCD_LED_PIN_INDEX;
    }
    else
    {
        BOARD_SPILCD_LED_GPIO_BASE->DR &= ~(1<<BOARD_SPILCD_LED_PIN_INDEX);
...
void BOARD_Camera_VsynPinInit(void)
{
    ...
    GPIO_PinInit(BOARD_CAMERA_VSYNC_GPIO_BASE, BOARD_CAMERA_VSYNC_PIN_INDEX, &gpioPinConfig);
    GPIO_EnableInterrupts(BOARD_CAMERA_VSYNC_GPIO_BASE, 1u << BOARD_CAMERA_VSYNC_PIN_INDEX);
    EnableIRQ(BOARD_CAMERA_VSYNC_IRQn);
}
