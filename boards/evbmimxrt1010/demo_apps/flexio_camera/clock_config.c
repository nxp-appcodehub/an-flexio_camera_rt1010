...
void BOARD_BootClockRUN(void)
{
    ...
    /* Set LPSPI_PODF. */
    CLOCK_SetDiv(kCLOCK_LpspiDiv, 5);   /* divided by 6. */
    /* Set Lpspi clock source. */
    CLOCK_SetMux(kCLOCK_LpspiMux, 1);   /* derive from PLL3 PFD0 - 720MHz. */
    ...
    /* Set LPI2C_CLK_PODF. */
    CLOCK_SetDiv(kCLOCK_Lpi2cDiv, 4);   /* divided by 5. */
    /* Set Lpi2c clock source. */
    CLOCK_SetMux(kCLOCK_Lpi2cMux, 0);   /* derive from PLL3_60MHz. */
    ...
    CLOCK_SetDiv(kCLOCK_Flexio1PreDiv, 1);  /* divided by 2. */
    /* Set FLEXIO1_CLK_PODF. */
    CLOCK_SetDiv(kCLOCK_Flexio1Div, 1);     /* divided by 2. */
    /* Set Flexio1 clock source. */
    CLOCK_SetMux(kCLOCK_Flexio1Mux, 3);     /* derive from PLL3 SW CLK: 480MHz. */
